...
// Named BIN fieldsPreconfigured values (IP2Location product ids).
const (
...
// registerBINPresets adds IP2Location DB1–DB26, LITE DB1–DB11, and ASN LITE.
// Column sets follow the official IP2Location package comparison (Record keys only).
func registerBINPresets() {
...
// ip2locMap is the IP2Location Record keys for the enabled columns.
